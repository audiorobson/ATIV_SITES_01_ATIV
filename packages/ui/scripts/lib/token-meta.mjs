...
export const recipes = {
  ...
  "chrome.topo": {
    selectors: [".ativ-topo", ".ativ-topo__barra", ".ativ-nav"],
    values: ["62px", "12px", ".1em", "90", "91", "860px"],
    note: "Altura 62px e z-index 90 vêm da barra da biblioteca de marca, extraidos como receita. Alvo 44px no link. Condensacao a 860px troca lockup por simbolo e o nav inline pelo details .ativ-menu.",
  },
  "chrome.menu": {
  ...
  "pages.indice-relacionados": {
    ...
    values: ["44px"],
    note: "Indice local usa ancoras e :target, sem JS. Solucao: coluna sticky acima de 860px. Setor e estreito: indice em linha com wrap. Relacionados e proxima leitura nao sao rotas de producao. Abaixo de 860px (e .ativ-pagina--estreito) o .ativ-com-lateral da pagina empilha em coluna de largura total; min-inline-size 0 evita herdar 68ch depois do stack.",
  },
};
